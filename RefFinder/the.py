...
# TODO0====================
    ...
    # while searching  "cm2g",    cm2, g is split.   so dont consider single alphabets. Also make sure numbers dont make em split

    # while searching america. show usa

    # "primary vent manifold" when u search this u get 0 result coz its a col name. so if u dont get results, do els case where it searches col name as well

    # "MS5002 GT executed after 2018 where pressure transmitter supplier is Rosemount"  here after 2018. year not detecting. do something abt it cuh

    # "Projects having manifold material of AISI 316 (STD) and a product structuring of 50%"  here % not working and  value has product structuring which is also a col. so....
